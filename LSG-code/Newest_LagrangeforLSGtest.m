...
%% Introduction
% This script runs the verification experiment for the Lagrange-type
...
%
% Current setting:
%   - finite element: P4 Lagrange-type stress element
%   - right-hand side: La_Ipf_LSG.m
%   - reference solution: solutiota10e2new.mat, if iota = 1.0e-02
%   - small parameter: iota = 1.0e-02
%
% Important:
